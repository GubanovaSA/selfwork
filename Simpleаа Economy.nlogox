...
<model version="NetLogo 7.0.4" snapToGrid="false">
  <code><![CDATA[;; MODIFIED SIMPLE ECONOMY WITH TAXATION
;; Автор: Губанова Светлана, Войнова Екатерина, Братченко Арина

globals [ tax-rate tax-revenue ]
turtles-own [ wealth ]
...
to go
  set tax-revenue 0
  ask turtles with [wealth > 200] [
    let tax (wealth * tax-rate / 100)
    set wealth wealth - tax
    set tax-revenue tax-revenue + tax
  ]
  let poor-count count turtles with [wealth < 100]
  if poor-count > 0 [
    let share tax-revenue / poor-count
    ask turtles with [wealth < 100] [ set wealth wealth + share ]
  ]
  ask turtles with [wealth > 0] [ transact ]
  ask turtles [
    if wealth <= max-pxcor [ set xcor wealth ]
    ifelse wealth <= 100 [ set color red ] [ set color green ]
  ]
  tick
end
...
to-report top-10-pct-wealth
  let n count turtles
  let top-n ceiling(n * 0.10)
  report sum [wealth] of max-n-of top-n turtles [wealth]
end

to-report bottom-50-pct-wealth
  let n count turtles
  let bottom-n ceiling(n * 0.50)
  report sum [wealth] of min-n-of bottom-n turtles [wealth]
end]]></code>
  <widgets>
...
histogram [ wealth ] of turtles</update>
    ...
    <plot x="233" autoPlotX="true" yMax="10000.0" autoPlotY="true" y="336" xMin="0.0" height="192" legend="true" xMax="10.0" yMin="0.0" width="334" display="wealth by percent">
      <setup></setup>
      <update></update>
      <pen interval="1.0" mode="0" display="top 10%" color="-2674135" legend="true">
        <setup></setup>
        <update>plot top-10-pct-wealth</update>
      </pen>
      <pen interval="1.0" mode="0" display="bottom 50%" color="-13345367" legend="true">
        <setup></setup>
        <update>plot bottom-50-pct-wealth</update>
      </pen>
    </plot>
    <note x="602" y="341" backgroundDark="0" fontSize="14" width="150" markdown="false" height="18" textColorDark="-1" textColorLight="-16777216" backgroundLight="0">Богатые богатеют</note>
    <note x="608" y="525" backgroundDark="0" fontSize="14" width="150" markdown="false" height="18" textColorDark="-1" textColorLight="-16777216" backgroundLight="0">Бедные беднеют</note>
    <note x="66" y="188" backgroundDark="0" fontSize="16" width="150" markdown="false" height="40" textColorDark="-1" textColorLight="-10873583" backgroundLight="0">К курсу статистики и эконометрики</note>
  </widgets>
...
This model is in the IABM Textbook folder of the NetLogo Models Library. The model, as well as any updates to the model, can also be found on the textbook website: http://www.intro-to-abm.com/.]]></info>
  <turtleShapes>
